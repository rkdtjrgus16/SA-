 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ze{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(n=>{if(Ve(n)){const s=n.getImmediate();return`${s.library}/${s.version}`}else return null}).filter(n=>n).join(" ")}}function Ve(t){const e=t.getComponent();return e?.type==="VERSION"}const R="@firebase/app",V="0.10.13";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Mt(t){L(new _("platform-logger",e=>new ze(e),"PRIVATE")),L(new _("heartbeat",e=>new Bt(e),"PRIVATE")),B(R,V,t),B(R,V,"esm2017"),B("fire-js","")}Mt("");export{Et as A,_ as C,$ as D,Q as E,g as F,Me as L,Jt as S,Wt as _,fe as a,Kt as b,Vt as c,T as d,Z as e,Gt as f,Rt as g,jt as h,Ft as i,Pt as j,xt as k,h as l,Ht as m,ce as n,Lt as o,L as p,Ut as q,B as r,zt as s,Nt as t,$t as u,kt as v,It as w,W as x,I as y,P as z};
